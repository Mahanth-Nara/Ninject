...
namespace Ioc.Web.Controllers
{
    public class UserController : Controller
    {
        ...
        //Normally mvc controller doesnt have the parameterised constructor
        //Since we are using Ninject to do dependecy injection 
        //we are injecting the interface 
        ...
        /// <summary>
        /// Whille creating new user
        /// retursn the view with empty fields
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// creates the new user with entered details
        /// Or modify the user
        /// </summary>
